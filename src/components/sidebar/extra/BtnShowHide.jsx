...
const BtnShowHide = () => {
   ...
   return (
      <div className="relative p-0 absolute flex flex-col items-start left-0 h-[100vh] w-[5px] bg-slate-500 dark:bg-slate-900 text-slate-900 dark:text-slate-100 gap-2 py-5">
         ...
         <a className="flex w-max h-max items-centter justify-center p-2 rounded bg-lime-500 dark:bg-lime-900" href={waLink} target="_blank">
            <img src={ waLogo } className="w-5 h-5" />
         </a>
      </div>
   )
}
