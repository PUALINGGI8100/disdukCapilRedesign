...
import Layanan2 from './components/main/layanan/layanan2'
import Layanan3 from './components/main/layanan/layanan3'
      ...
      <div className="overflow-x-hidden">
        ...
        <BrowserRouter>
          <main className="flex w-full">
            ...
            <div className="main-scroll w-full h-full max-h-[100vh] flex flex-col sm:flex-row p-3 overflow-y-auto bg-white">
              <div className="sticky top-0 w-full sm:w-[40%] h-full flex flex-col">
                <CardKadis />
              </div>
              <div className="flex relative w-full h-full flex flex-col z-10">
                <span className="absolute sm:hidden left-0 top-0 min-h-full bg-slate-100 z-5 opacity-50 blur-sm backdrop-blur-full backdrop-opacity-10 w-full"></span>
                <div className="z-10">
                  <Routes>
                    ...
                    <Route path="/layanan" element={<Layanan />}>
                      ...
                      <Route path="2" element={<Layanan2 />} />
                      <Route path="3" element={<Layanan3 />} />
